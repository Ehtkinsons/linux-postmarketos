...
static int wcd9320_config_compander(struct snd_soc_component *, int, int);
static int wcd9320_codec_vote_max_bw(struct snd_soc_component *comp,
				   bool vote);

static const struct wcd9320_reg_mask_val wcd9320_spkr_default[] = {
	{WCD9320_CDC_COMPANDER7_CTL3, 0x80, 0x80},
	{WCD9320_CDC_COMPANDER8_CTL3, 0x80, 0x80},
	{WCD9320_CDC_COMPANDER7_CTL7, 0x01, 0x01},
	{WCD9320_CDC_COMPANDER8_CTL7, 0x01, 0x01},
	{WCD9320_CDC_BOOST0_BOOST_CTL, 0x7C, 0x50},
	{WCD9320_CDC_BOOST1_BOOST_CTL, 0x7C, 0x50},
};

static const struct wcd9320_reg_mask_val wcd9320_spkr_mode1[] = {
	{WCD9320_CDC_COMPANDER7_CTL3, 0x80, 0x00},
	{WCD9320_CDC_COMPANDER8_CTL3, 0x80, 0x00},
	{WCD9320_CDC_COMPANDER7_CTL7, 0x01, 0x00},
	{WCD9320_CDC_COMPANDER8_CTL7, 0x01, 0x00},
	{WCD9320_CDC_BOOST0_BOOST_CTL, 0x7C, 0x44},
	{WCD9320_CDC_BOOST1_BOOST_CTL, 0x7C, 0x44},
};

static void wcd9320_enable_sido_buck(struct snd_soc_component *component)
{
	struct wcd9320_priv *wcd = dev_get_drvdata(component->dev);

	snd_soc_component_update_bits(component, WCD9320_ANA_RCO, 0x80, 0x80);
	snd_soc_component_update_bits(component, WCD9320_ANA_BUCK_CTL, 0x02, 0x02);
	/* 100us sleep needed after IREF settings */
	usleep_range(100, 110);
	snd_soc_component_update_bits(component, WCD9320_ANA_BUCK_CTL, 0x04, 0x04);
	/* 100us sleep needed after VREF settings */
	usleep_range(100, 110);
	wcd->sido_input_src = SIDO_SOURCE_RCO_BG;
}

static void wcd9320_cdc_sido_ccl_enable(struct wcd9320_priv *wcd, bool ccl_flag)
{
	...
	if (ccl_flag) {
		if (++wcd->sido_ccl_cnt == 1)
			snd_soc_component_update_bits(component,
				WCD9320_SIDO_SIDO_CCL_10, 0xFF, 0x6E);
	} else {
		...
		if (--wcd->sido_ccl_cnt == 0)
			snd_soc_component_update_bits(component,
				WCD9320_SIDO_SIDO_CCL_10, 0xFF, 0x02);
	}
}

static bool wcd9320_cdc_is_svs_enabled(struct wcd9320_priv *wcd)
{
	if (WCD9320_IS_2_0(wcd->version) &&
		svs_scaling_enabled)
		return true;
...
static int wcd9320_enable_mclk(struct wcd9320_priv *wcd)
{
	...
	if (++wcd->clk_mclk_users == 1) {
		...
		regmap_update_bits(wcd->regmap,
				   WCD9320_ANA_CLK_TOP, 0x80, 0x80);
		regmap_update_bits(wcd->regmap,
				   WCD9320_ANA_CLK_TOP, 0x08, 0x00);
		regmap_update_bits(wcd->regmap,
				   WCD9320_ANA_CLK_TOP, 0x04, 0x04);
		regmap_update_bits(wcd->regmap,
				   WCD9320_CDC_CLK_RST_CTRL_FS_CNT_CONTROL,
				   0x01, 0x01);
		regmap_update_bits(wcd->regmap,
				   WCD9320_CDC_CLK_RST_CTRL_MCLK_CONTROL,
				   0x01, 0x01);
		/*
...
static int wcd9320_disable_mclk(struct wcd9320_priv *wcd)
{
	...
	if (--wcd->clk_mclk_users == 0) {
		...
		regmap_update_bits(wcd->regmap, WCD9320_ANA_CLK_TOP,
						 0x80, 0x00);
	}
...
int wcd9320_disable_master_bias(struct wcd9320_priv *wcd)
{
	...
	wcd->master_bias_users--;
	if (wcd->master_bias_users == 0) {
		regmap_update_bits(wcd->regmap, WCD9320_ANA_BIAS,
						 0x80, 0x00);
		regmap_update_bits(wcd->regmap, WCD9320_ANA_BIAS,
						 0x20, 0x00);
	}
...
static int wcd9320_cdc_check_sido_value(enum wcd9320_sido_voltage req_mv)
{
...
static void wcd9320_codec_apply_sido_voltage(
				struct wcd9320_priv *wcd,
				enum wcd9320_sido_voltage req_mv)
{
	u32 vout_d_val;
	struct snd_soc_component *component = wcd->component;
	int ret;
	...
	if (!wcd9320_cdc_is_svs_enabled(wcd))
		return;
	...
	ret = wcd9320_cdc_check_sido_value(req_mv);
	if (ret < 0) {
	...
	snd_soc_component_write(component, WCD9320_ANA_BUCK_VOUT_D, vout_d_val & 0xFF);
	snd_soc_component_update_bits(component, WCD9320_ANA_BUCK_CTL, 0x80, 0x80);

	/* 1 msec sleep required after SIDO Vout_D voltage change */
	usleep_range(1000, 1100);
	wcd->sido_voltage = req_mv;
	snd_soc_component_update_bits(component, WCD9320_ANA_BUCK_CTL,
				0x80, 0x00);
}

static int wcd9320_codec_update_sido_voltage(
				struct wcd9320_priv *wcd,
				enum wcd9320_sido_voltage req_mv)
{
	int ret = 0;
	...
	wcd9320_codec_apply_sido_voltage(wcd, req_mv);
				     ...
				     int event)
{
	...
	case SND_SOC_DAPM_POST_PMD:
		wcd9320_codec_vote_max_bw(component, true);

		wcd9320_codec_enable_slim_chmask(dai, false);
		wcd9320_codec_vote_max_bw(component, false);
			       ...
			       struct snd_ctl_elem_value *ucontrol)
{
	...
	case COMPANDER_1:
		...
		snd_soc_component_update_bits(component, WCD9320_HPH_L_EN, 0x20,
				(value ? 0x00:0x20));
		break;
	case COMPANDER_2:
		snd_soc_component_update_bits(component, WCD9320_HPH_R_EN, 0x20,
				(value ? 0x00:0x20));
		break;
	case COMPANDER_3:
		break;
	case COMPANDER_4:
		break;
	case COMPANDER_5:
		snd_soc_component_update_bits(component, WCD9320_SE_LO_LO3_GAIN, 0x20,
				(value ? 0x00:0x20));
		break;
	case COMPANDER_6:
		snd_soc_component_update_bits(component, WCD9320_SE_LO_LO4_GAIN, 0x20,
				(value ? 0x00:0x20));
		break;
	case COMPANDER_7:
		break;
		...
		struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		if (wcd->rx_bias_count == 1) {
			if (WCD9320_IS_2_0(wcd->version))
				wcd9320_codec_init_flyback(component);
			snd_soc_component_update_bits(component, WCD9320_ANA_RX_SUPPLIES,
					    0x01, 0x01);
		}
		break;
	case SND_SOC_DAPM_POST_PMD:
				      ...
				      int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		/* Read DEM INP Select */
		dem_inp = snd_soc_component_read32(component, WCD9320_CDC_RX2_RX_PATH_SEC0) &
			  0x03;
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		if ((hph_mode == CLS_H_LP) &&
		   (WCD9320_IS_1_1(wcd->version))) {
			snd_soc_component_update_bits(component, WCD9320_HPH_L_DAC_CTL,
					    0x03, 0x03);
		}
		break;
	case SND_SOC_DAPM_PRE_PMD:
				      ...
				      int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		/* Read DEM INP Select */
		dem_inp = snd_soc_component_read32(component, WCD9320_CDC_RX1_RX_PATH_SEC0) &
			  0x03;
		if (((hph_mode == CLS_H_HIFI) || (hph_mode == CLS_H_LOHIFI) ||
		     (hph_mode == CLS_H_LP)) && (dem_inp != 0x01)) {
			dev_err(component->dev, "%s: DEM Input not set correctly, hph_mode: %d\n",
...
static const struct snd_soc_dapm_widget wcd9320_dapm_i2s_widgets[] = {
	SND_SOC_DAPM_SUPPLY("RX_I2S_CTL", WCD9320_DATA_HUB_DATA_HUB_RX_I2S_CTL,
	0, 0, NULL, 0),
};
...
static u16 wcd9320_interp_get_primary_reg(u16 reg, u16 *ind)
{
	u16 prim_int_reg;

	switch (reg) {
	case WCD9320_CDC_RX0_RX_PATH_CTL:
	case WCD9320_CDC_RX0_RX_PATH_MIX_CTL:
		prim_int_reg = WCD9320_CDC_RX0_RX_PATH_CTL;
		*ind = 0;
		break;
	case WCD9320_CDC_RX1_RX_PATH_CTL:
	case WCD9320_CDC_RX1_RX_PATH_MIX_CTL:
		prim_int_reg = WCD9320_CDC_RX1_RX_PATH_CTL;
		*ind = 1;
		break;
	case WCD9320_CDC_RX2_RX_PATH_CTL:
	case WCD9320_CDC_RX2_RX_PATH_MIX_CTL:
		prim_int_reg = WCD9320_CDC_RX2_RX_PATH_CTL;
		*ind = 2;
		break;
	case WCD9320_CDC_RX3_RX_PATH_CTL:
	case WCD9320_CDC_RX3_RX_PATH_MIX_CTL:
		prim_int_reg = WCD9320_CDC_RX3_RX_PATH_CTL;
		*ind = 3;
		break;
	case WCD9320_CDC_RX4_RX_PATH_CTL:
	case WCD9320_CDC_RX4_RX_PATH_MIX_CTL:
		prim_int_reg = WCD9320_CDC_RX4_RX_PATH_CTL;
		*ind = 4;
		break;
	case WCD9320_CDC_RX5_RX_PATH_CTL:
	case WCD9320_CDC_RX5_RX_PATH_MIX_CTL:
		prim_int_reg = WCD9320_CDC_RX5_RX_PATH_CTL;
		*ind = 5;
		break;
	case WCD9320_CDC_RX6_RX_PATH_CTL:
	case WCD9320_CDC_RX6_RX_PATH_MIX_CTL:
		prim_int_reg = WCD9320_CDC_RX6_RX_PATH_CTL;
		*ind = 6;
		break;
	case WCD9320_CDC_RX7_RX_PATH_CTL:
	case WCD9320_CDC_RX7_RX_PATH_MIX_CTL:
		prim_int_reg = WCD9320_CDC_RX7_RX_PATH_CTL;
		*ind = 7;
		break;
	case WCD9320_CDC_RX8_RX_PATH_CTL:
	case WCD9320_CDC_RX8_RX_PATH_MIX_CTL:
		prim_int_reg = WCD9320_CDC_RX8_RX_PATH_CTL;
		*ind = 8;
		break;
	};
...
static int wcd9320_codec_enable_prim_interpolator(
				struct snd_soc_component *component,
				u16 reg, int event)
{
	struct wcd9320_priv *wcd = dev_get_drvdata(component->dev);
	...
	prim_int_reg = wcd9320_interp_get_primary_reg(reg, &ind);
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		if (wcd->prim_int_users[ind] == 1) {
			snd_soc_component_update_bits(component, prim_int_reg,
					    0x10, 0x10);
			wcd9320_codec_hd2_control(component, prim_int_reg, event);
			snd_soc_component_update_bits(component, prim_int_reg,
					    1 << 0x5, 1 << 0x5);
		}
...
static int __tasha_cdc_native_clk_enable(struct wcd9320_priv *wcd,
					 bool enable)
{
	int ret = 0;
	struct snd_soc_component *component = wcd->component;
	...
	if (enable) {
		...
		if (++wcd->native_clk_users == 1) {
			snd_soc_component_update_bits(component, WCD9320_CLOCK_TEST_CTL,
					    0x10, 0x10);
			snd_soc_component_update_bits(component, WCD9320_CLOCK_TEST_CTL,
					    0x80, 0x80);
			snd_soc_component_update_bits(component, WCD9320_CODEC_RPM_CLK_GATE,
					    0x04, 0x00);
			snd_soc_component_update_bits(component,
					WCD9320_CDC_CLK_RST_CTRL_MCLK_CONTROL,
					0x02, 0x02);
...
static int wcd9320_codec_get_native_fifo_sync_mask(struct snd_soc_component *component,
						 int interp_n)
{
	int mask = 0;
	u16 reg;
	...
	reg = WCD9320_CDC_RX_INP_MUX_RX_INT1_CFG0 + (2 * interp_n) - 2;
...
static int wcd9320_enable_native_supply(struct snd_soc_dapm_widget *w,
				      struct snd_kcontrol *kcontrol, int event)
{
	int mask;
	struct snd_soc_component *component = snd_soc_dapm_to_component(w->dapm);
	...
	interp_reg = WCD9320_CDC_RX1_RX_PATH_CTL + 20 * (w->shift - 1);

	mask = wcd9320_codec_get_native_fifo_sync_mask(component, w->shift);
	if (!mask)
		return -EINVAL;
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		snd_soc_component_update_bits(component, WCD9320_DATA_HUB_NATIVE_FIFO_SYNC,
				    mask, mask);
		break;
	case SND_SOC_DAPM_PRE_PMD:
		snd_soc_component_update_bits(component, WCD9320_DATA_HUB_NATIVE_FIFO_SYNC,
		...
		struct snd_kcontrol *kcontrol, int event)
{
	...
	if (!(strcmp(w->name, "RX INT0 INTERP"))) {
		reg = WCD9320_CDC_RX0_RX_PATH_CTL;
		gain_reg = WCD9320_CDC_RX0_RX_VOL_CTL;
	} else if (!(strcmp(w->name, "RX INT1 INTERP"))) {
		reg = WCD9320_CDC_RX1_RX_PATH_CTL;
		gain_reg = WCD9320_CDC_RX1_RX_VOL_CTL;
	} else if (!(strcmp(w->name, "RX INT2 INTERP"))) {
		reg = WCD9320_CDC_RX2_RX_PATH_CTL;
		gain_reg = WCD9320_CDC_RX2_RX_VOL_CTL;
	} else if (!(strcmp(w->name, "RX INT3 INTERP"))) {
		reg = WCD9320_CDC_RX3_RX_PATH_CTL;
		gain_reg = WCD9320_CDC_RX3_RX_VOL_CTL;
	} else if (!(strcmp(w->name, "RX INT4 INTERP"))) {
		reg = WCD9320_CDC_RX4_RX_PATH_CTL;
		gain_reg = WCD9320_CDC_RX4_RX_VOL_CTL;
	} else if (!(strcmp(w->name, "RX INT5 INTERP"))) {
		reg = WCD9320_CDC_RX5_RX_PATH_CTL;
		gain_reg = WCD9320_CDC_RX5_RX_VOL_CTL;
	} else if (!(strcmp(w->name, "RX INT6 INTERP"))) {
		reg = WCD9320_CDC_RX6_RX_PATH_CTL;
		gain_reg = WCD9320_CDC_RX6_RX_VOL_CTL;
	} else if (!(strcmp(w->name, "RX INT7 INTERP"))) {
		reg = WCD9320_CDC_RX7_RX_PATH_CTL;
		gain_reg = WCD9320_CDC_RX7_RX_VOL_CTL;
	} else if (!(strcmp(w->name, "RX INT8 INTERP"))) {
		reg = WCD9320_CDC_RX8_RX_PATH_CTL;
		gain_reg = WCD9320_CDC_RX8_RX_VOL_CTL;
	} else {
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		/* Reset if needed */
		wcd9320_codec_enable_prim_interpolator(component, reg, event);
		break;
	case SND_SOC_DAPM_POST_PMU:
		wcd9320_config_compander(component, w->shift, event);
		val = snd_soc_component_read32(component, gain_reg);
		val += offset_val;
		snd_soc_component_write(component, gain_reg, val);
		break;
...
tatic const struct soc_enum cf_dec1_enum =
	SOC_ENUM_SINGLE(TAIKO_A_CDC_TX1_MUX_CTL, 4, 3, rx_cf_text);

static const struct soc_enum cf_dec2_enum =
	SOC_ENUM_SINGLE(TAIKO_A_CDC_TX2_MUX_CTL, 4, 3, rx_cf_text);

static const struct soc_enum cf_dec3_enum =
	SOC_ENUM_SINGLE(TAIKO_A_CDC_TX3_MUX_CTL, 4, 3, rx_cf_text);

static const struct soc_enum cf_dec4_enum =
	SOC_ENUM_SINGLE(TAIKO_A_CDC_TX4_MUX_CTL, 4, 3, rx_cf_text);

static const struct soc_enum cf_dec5_enum =
	SOC_ENUM_SINGLE(TAIKO_A_CDC_TX5_MUX_CTL, 4, 3, rx_cf_text);

static const struct soc_enum cf_dec6_enum =
	SOC_ENUM_SINGLE(TAIKO_A_CDC_TX6_MUX_CTL, 4, 3, rx_cf_text);

static const struct soc_enum cf_dec7_enum =
	SOC_ENUM_SINGLE(TAIKO_A_CDC_TX7_MUX_CTL, 4, 3, rx_cf_text);

static const struct soc_enum cf_dec8_enum =
	SOC_ENUM_SINGLE(TAIKO_A_CDC_TX8_MUX_CTL, 4, 3, rx_cf_text);

static const struct soc_enum cf_dec9_enum =
	SOC_ENUM_SINGLE(TAIKO_A_CDC_TX9_MUX_CTL, 4, 3, rx_cf_text);

static const struct soc_enum cf_dec10_enum =
	SOC_ENUM_SINGLE(TAIKO_A_CDC_TX10_MUX_CTL, 4, 3, rx_cf_text);
...
static int wcd9320_config_compander(struct snd_soc_component *component, int interp_n,
				  int event)
{
	struct wcd9320_priv *wcd = dev_get_drvdata(component->dev);
	int comp;
	...
	comp_ctl0_reg = WCD9320_CDC_COMPANDER1_CTL0 + (comp * 8);
	rx_path_cfg0_reg = WCD9320_CDC_RX1_RX_PATH_CFG0 + (comp * 20);
...
static int _wcd9320_codec_enable_mclk(struct snd_soc_component *component, int enable)
{
	...
	if (enable) {
		...
		wcd9320_codec_apply_sido_voltage(wcd,
				SIDO_VOLTAGE_NOMINAL_MV);
	} else {
		clear_bit(AUDIO_NOMINAL, &wcd->status_mask);
		wcd9320_codec_update_sido_voltage(wcd,
...
static int wcd9320_set_mix_interpolator_rate(struct snd_soc_dai *dai,
...
static int wcd9320_set_prim_interpolator_rate(struct snd_soc_dai *dai,
	...
	list_for_each_entry(ch, &wcd->dai[dai->id].wcd_slim_ch_list, list) {
		...
		if ((int_1_mix1_inp < INTn_1_MIX_INP_SEL_RX0) ||
		   (int_1_mix1_inp > INTn_1_MIX_INP_SEL_RX7)) {
			pr_err("%s: Invalid RX%u port, Dai ID is %d\n",
				__func__,
				(ch->port - WCD9320_RX_PORT_START_NUMBER),
				dai->id);
			return -EINVAL;
		}

		int_mux_cfg0 = WCD9320_CDC_RX_INP_MUX_RX_INT0_CFG0;
		...
		for (j = 0; j < WCD9320_NUM_INTERPOLATORS; j++) {
			...
			if ((inp0_sel == int_1_mix1_inp) ||
				...
				int_fs_reg = WCD9320_CDC_RX0_RX_PATH_CTL +
					     20 * j;
	...
	list_for_each_entry(ch, &wcd->dai[dai->id].wcd_slim_ch_list, list) {
		...
		for (j = 0; j < NUM_INTERPOLATORS; j++) {
			...
			if (((rx_mix_1_reg_1_val & 0x0F) == rx_mix1_inp) ||
				...
				snd_soc_update_bits(codec, rx_fs_reg, 0xE0, rate_val << 5);
			}
			if (j < 2)
				rx_mix_1_reg_1 += 3;
			else
		...
		if (wcd->intf_type == WCD_INTERFACE_TYPE_I2C) {
			if (dai->id == AIF1_CAP)
				snd_soc_component_update_bits(dai->component,
					WCD9320_DATA_HUB_DATA_HUB_TX_I2S_CTL,
					0x2, 0);
			else if (dai->id == AIF1_PB)
				snd_soc_component_update_bits(dai->component,
					WCD9320_DATA_HUB_DATA_HUB_RX_I2S_CTL,
					0x2, 0);
		}
		break;
...
static const struct wcd9320_reg_mask_val wcd9320_reg_update_reset_val_1_1[] = {
	{WCD9320_RCO_CTRL_2, 0xFF, 0x47},
	{WCD9320_FLYBACK_VNEG_DAC_CTRL_4, 0xFF, 0x60},
};

static const struct wcd9320_reg_mask_val wcd9320_codec_reg_init_val_1_1[] = {
	{WCD9320_FLYBACK_VNEG_DAC_CTRL_1, 0xFF, 0x65},
	{WCD9320_FLYBACK_VNEG_DAC_CTRL_2, 0xFF, 0x52},
	{WCD9320_FLYBACK_VNEG_DAC_CTRL_3, 0xFF, 0xAF},
	{WCD9320_FLYBACK_VNEG_DAC_CTRL_4, 0xFF, 0x60},
	{WCD9320_FLYBACK_VNEG_CTRL_3, 0xFF, 0xF4},
	{WCD9320_FLYBACK_VNEG_CTRL_9, 0xFF, 0x40},
	{WCD9320_FLYBACK_VNEG_CTRL_2, 0xFF, 0x4F},
	{WCD9320_FLYBACK_EN, 0xFF, 0x6E},
	{WCD9320_CDC_RX2_RX_PATH_SEC0, 0xF8, 0xF8},
	{WCD9320_CDC_RX1_RX_PATH_SEC0, 0xF8, 0xF8},
};

static const struct wcd9320_reg_mask_val wcd9320_codec_reg_init_val_1_0[] = {
	{WCD9320_FLYBACK_VNEG_CTRL_3, 0xFF, 0x54},
	{WCD9320_CDC_RX2_RX_PATH_SEC0, 0xFC, 0xFC},
	{WCD9320_CDC_RX1_RX_PATH_SEC0, 0xFC, 0xFC},
};

static const struct wcd9320_reg_mask_val wcd9320_codec_reg_init_val_2_0[] = {
	{WCD9320_RCO_CTRL_2, 0x0F, 0x08},
	{WCD9320_RX_BIAS_FLYB_MID_RST, 0xF0, 0x10},
	{WCD9320_FLYBACK_CTRL_1, 0x20, 0x20},
	{WCD9320_HPH_OCP_CTL, 0xFF, 0x5A},
	{WCD9320_HPH_L_TEST, 0x01, 0x01},
	{WCD9320_HPH_R_TEST, 0x01, 0x01},
	{WCD9320_CDC_BOOST0_BOOST_CFG1, 0x3F, 0x12},
	{WCD9320_CDC_BOOST0_BOOST_CFG2, 0x1C, 0x08},
	{WCD9320_CDC_COMPANDER7_CTL7, 0x1E, 0x18},
	{WCD9320_CDC_BOOST1_BOOST_CFG1, 0x3F, 0x12},
	{WCD9320_CDC_BOOST1_BOOST_CFG2, 0x1C, 0x08},
	{WCD9320_CDC_COMPANDER8_CTL7, 0x1E, 0x18},
	{WCD9320_CDC_TX0_TX_PATH_SEC7, 0xFF, 0x45},
	{WCD9320_CDC_RX0_RX_PATH_SEC0, 0xFC, 0xF4},
	{WCD9320_HPH_REFBUFF_LP_CTL, 0x08, 0x08},
	{WCD9320_HPH_REFBUFF_LP_CTL, 0x06, 0x02},
};
...
static int wcd9320_setup_irqs(struct wcd9320_priv *wcd)
{
	...
	ret = wcd9320_request_irq(wcd, WCD9320_IRQ_SLIMBUS,
				  wcd9320_slimbus_irq, "SLIMBUS Slave", wcd);
	if (ret) {
...
static void wcd9320_cleanup_irqs(struct wcd9320_priv *w)
{
        free_irq(regmap_irq_get_virq(w->irq_data, WCD9320_IRQ_SLIMBUS), w);
}
*/
...
static int wcd9320_codec_probe(struct snd_soc_component *component)
{
	...
	snd_soc_component_update_bits(component, TAIKO_A_CHIP_CTL,
				      0x06, 0x02);
